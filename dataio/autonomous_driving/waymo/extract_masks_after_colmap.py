...
@original author Jianfei Guo, Shanghai AI Lab
...
if __name__ == "__main__":
    ...
    # Custom configs
    parser.add_argument('--data_root', type=str, default='../../../../../data/waymo/colmap')
    ...
    if args.seq_list is not None:
        ...
        select_scene_ids = list(sorted(glob(os.path.join(args.data_root, "*", "run-colmap-photometric.sh"))))
    ...
    for scene_i, scene_id in enumerate(tqdm(select_scene_ids, f'Extracting masks ...')):
        ...
        for fpath in tqdm(flist, f'scene[{scene_i}]'):
